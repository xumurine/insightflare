...
const enMessages = {
  ...
  devices: {
    ...
    browserByDeviceTitle: "Device Type x Browser",
    osByDeviceTitle: "Device Type x Operating System",
    otherLabel: "Other",
    screenBucketLabels: {
  ...
  browsers: {
    ...
    osBreakdownTitle: "Browser x Operating System",
    deviceTypeBreakdownTitle: "Browser x Device Type",
    otherLabel: "Other",
  ...
  accountSettings: {
    ...
    subtitle:
      "Manage your personal details, login password, and dashboard timezone.",
    ...
    timeZoneTitle: "Reporting Timezone",
    timeZoneDescription:
      "Calendar ranges and aggregation buckets use this timezone across the dashboard.",
    activeTimeZone: "Active timezone",
    browserTimeZone: "Browser timezone",
    browserUnavailable: "Not detected",
    browserSource: "Browser",
    manualSource: "Manual",
    preferenceLabel: "Timezone preference",
    preferenceDescription:
      "Browser mode follows this device. Manual mode keeps the same timezone on every device.",
    useBrowser: "Use browser timezone",
    useCustom: "Choose a timezone",
    customTimeZoneLabel: "Timezone",
    customTimeZoneDescription: "Choose from supported IANA timezones.",
    invalidTimeZone: "Please choose a valid IANA timezone.",
    save: "Save preference",
    saving: "Saving...",
    saved: "Timezone preference saved.",
    saveFailed: "Failed to save timezone preference.",
  },
  notificationCenter: {
...
const jaMessages = {
  ...
  geo: {
    ...
    timezoneDeltaVsLocal: "ローカルとの差: {delta}",
  ...
  devices: {
    ...
    browserByDeviceTitle: "デバイス種別 x ブラウザー",
    osByDeviceTitle: "デバイス種別 x OS",
    otherLabel: "その他",
    screenBucketLabels: {
  ...
  browsers: {
    ...
    osBreakdownTitle: "ブラウザー x OS",
    deviceTypeBreakdownTitle: "ブラウザー x デバイス種別",
    otherLabel: "その他",
  ...
  systemSettings: {
    ...
    botAnalyticsAccountIdLabel: "Cloudflare Account ID",
    botAnalyticsApiTokenLabel: "Cloudflare API token",
    botAnalyticsApiTokenPlaceholder: "ガイドを見て Cloudflare API token を取得",
    ...
    botAnalyticsGuideSteps: [
      ...
      "トークンをコピーし、ここに Account ID と API token を入力します。",
    ],
    ...
    loginTurnstilePrivacyNotice:
      "Cloudflare Turnstile コンソールで Invisible widget を作成してください。セルフホスト環境では、プライバシーポリシーが Cloudflare Turnstile の要件に合っていることを確認してください。",
    ...
    loginTurnstileGuideSteps: [
      ...
      "新しい widget を作成し、Invisible モードを選択します。",
      "現在の InsightFlare ログインドメインを許可ホスト名に追加します。",
      "widget 作成後に Site Key と Secret Key をコピーします。",
    ...
    resendApiKeyLabel: "Resend API Key",
    resendApiKeyPlaceholder: "ガイドを見て Resend API key を取得",
