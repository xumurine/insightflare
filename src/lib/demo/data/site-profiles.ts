...
import { DEMO_SITE_PROFILES_PART_1 } from "./site-profiles-part-1";
import { DEMO_SITE_PROFILES_PART_2 } from "./site-profiles-part-2";
import { DEMO_SITE_PROFILES_PART_3 } from "./site-profiles-part-3";
import type { DemoSiteProfile } from "./site-profiles-types";
export type {
  DemoSiteHourProfile,
  DemoSiteProfile,
} from "./site-profiles-types";
