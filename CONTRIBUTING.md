...
At minimum, local secret-backed flows need `MAIN_SECRET` and `BOOTSTRAP_ADMIN_PASSWORD`. Legacy `DAILY_SALT_SECRET` is still supported for migration tests, but new development should prefer `MAIN_SECRET`.
